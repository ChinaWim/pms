...
<div id="toolbar">
    ...
    <a id = "addBtn" href="javascript:void(0);" class="easyui-linkbutton" data-options="text:'上传论文',iconCls:'icon-add',plain:true"> </a>
    <a id = "downloadMyBtn" href="javascript:void(0);" class="easyui-linkbutton" data-options="text:'下载我的论文',iconCls:'icon-ok',plain:true"> </a>
    <a id = "downloadTBtn" href="javascript:void(0);" class="easyui-linkbutton" data-options="text:'下载老师批改的论文',iconCls:'icon-ok',plain:true"> </a>
</div>
<!--论文表格-->
<table id="dg"></table>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#dg').datagrid({
            url:'student/showPaper',
            columns:[[
                {field:'paperId',title:'论文ID号',width:100,align:'center'},
                {field:'projectName',title:'课题名称',width:100,align:'center'},
                {field:'teacher',title:'指导老师姓名',width:100,align:'center',formatter: function(value,row,index){
                    return value.teacherName;
                }    },
                {field:'paperFlag',title:'目前情况',width:50,align:'center',formatter: function(value,row,index){
                    if(value == '0') return '<font color="blue">老师未批改<font>';
                    if(value == '1')  return '<font color="green">老师已批改<font>';
                }    },
                {field:'studentUploadtime',title:'我上传论文日期',width:100,align:'center'},
                {field:'teacherUploadtime',title:'老师批改论文日期',width:100,align:'center'},
        ...
        $('#downloadMyBtn').bind('click', function(){
            ...
            if(!paper.studentPath){
                $.messager.alert('错误提醒','你还未上传论文！','error');
                return false;
            }
...
//                $('#dg').datagrid('reload');//刷新表格
        ...
        $('#downloadTBtn').bind('click', function(){
            ...
            if(paper.paperFlag == '0'){
                $.messager.alert('错误提醒','老师还未批改！','error');
                return false;
            }
